...
var resolverTorre = function (totalTorreDiscos, pinoInicialTorre, pinoFinalTorre, pinoAuxiliarTorre) {
    if (totalTorreDiscos > 0) {
        ...
        totalMovimentos++;
        document.getElementById("jogo_log").innerHTML = document.getElementById("jogo_log").innerHTML + "<br> Movendo disco de " + pinoInicialTorre + " para " + pinoFinalTorre;
        console.log("Movendo disco de " + pinoInicialTorre + " para " + pinoFinalTorre);
